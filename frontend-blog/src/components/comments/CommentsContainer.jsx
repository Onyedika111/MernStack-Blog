      ...
      <div className={`${className}`}>
          ...
          <div className='space-y-4 mt-8'>
              {comments.map((comment) => (
                  <Comment key={comment._id} affectedComment={affectedComment} setAffectedComment={setAffectedComment} comment={comment} logginedUserId={logginedUserId} addComment={addCommentHandler} updateComment={updateCommentHandler} deleteComment={deleteCommentHandler} replies={comment.replies} />
              ))}
          </div>
    </div>
  )
